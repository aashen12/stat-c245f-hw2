...
library(xtable)
filelist=c("3-Bd-SP_S1_L001_R2_001.fastq.gz","6-Bd-DN_S2_L001_R2_001.fastq.gz","10-Bd-DP_S3_L001_R2_001.fastq.gz","13-Cc-SP_S4_L001_R2_001.fastq.gz","22-Cc-DN_S6_L001_R2_001.fastq.gz","14-Cc-DP_S5_L001_R2_001.fastq.gz","23-Plasmid-5k_S7_L001_R2_001.fastq.gz");
labellist=c("BeadSP","BeadDN","BeadDP","CcSP","CcDN","CcDP","Plasmid5kCTRL");
reads=c(1457639,2133768,1622884,2194897,1199676,2107645,2029375);
mappedreads=c(1043551,1594781,1197519,1654998,870950,1619259,1551986);
totalsgrnas=c(4996,4996,4996,4996,4996,4996,4996);
zerocounts=c(0,0,0,4,79,543,0);
giniindex=c(0.0509878446517924,0.04625168459040396,0.06332758554514806,0.13987801108874198,0.18728672178985473,0.32958697638712964,0.013432404510872686);
...
genboxplot("Comparison_to_5k_plasmid.count_normalized.txt");
@
...
genhistplot("Comparison_to_5k_plasmid.count_normalized.txt");
@
...
genpcaplot("Comparison_to_5k_plasmid.count_normalized.txt");
@
...
<<fig=TRUE,echo=FALSE,width=5.5,height=5.5>>=
genclustering("Comparison_to_5k_plasmid.count_normalized.txt");
@
