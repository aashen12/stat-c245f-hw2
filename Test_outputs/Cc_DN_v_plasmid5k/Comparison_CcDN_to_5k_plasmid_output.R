pdf(file='Comparison_CcDN_to_5k_plasmid_output.pdf',width=4.5,height=4.5);
...
dev.off()
Sweave("Comparison_CcDN_to_5k_plasmid_output_summary.Rnw");
library(tools);

texi2dvi("Comparison_CcDN_to_5k_plasmid_output_summary.tex",pdf=TRUE);
