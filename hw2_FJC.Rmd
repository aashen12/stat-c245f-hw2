...
count_data[which(mh_pval < sig_level), "Gene"]
count_data[which(mcd_pval < sig_level), "Gene"]
count_data[which(tmh_pval < sig_level), "Gene"]
count_data[which(tmcd_pval < sig_level), "Gene"]
