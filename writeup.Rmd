...
bdp_genes <- read.table(paste0(test_dir, bdp, "Comparison_BeadDP_to_5k_plasmid_output.gene_summary.txt"), header = TRUE)
bdp_sgrna <- read.table(paste0(test_dir, bdp, "Comparison_BeadDP_to_5k_plasmid_output.sgrna_summary.txt"), header = TRUE)
```
